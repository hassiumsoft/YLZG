...
//                               alignment:self.textAlignment];
            [self.placeHolder boundingRectWithSize:placeHolderRect.size options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName:self.font} context:nil];
        }
    }
}
