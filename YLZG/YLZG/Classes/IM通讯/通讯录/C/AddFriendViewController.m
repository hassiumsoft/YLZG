...
- (void)getData
{
    ...
    NSString *url = [NSString stringWithFormat:@"http://192.168.0.160/index.php/home/easemob/fuzzy_search?uid=%@&info=%@",account.userID,self.searchBar.text];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.addBtn = ^(){
        ...
        if ([self didBuddyExist:model.uid]) {
            ...
            NSString *url = [NSString stringWithFormat:@"http://192.168.0.160/index.php/home/easemob/askfriend?uid=%@&aname=%@&anick=%@&ahead=%@&msg=%@&fuid=%@&fname=%@&fnick=%@&fhead=%@",account.userID,myModel.username,myModel.nickname,myModel.head,self.message,model.uid,model.name,model.nickname,model.head];
            self.putURL = url;
