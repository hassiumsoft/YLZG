...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.agreeBtn = ^(BUTTON_FLAG flag){
        ...
        NSString *url = [NSString stringWithFormat:@"http://192.168.0.158/index.php/home/easemob/handle_ask?uid=%@&auid=%@&msg=%@&id=%@&status=%d",myModel.uid,applyModel.auid,self.message,applyModel.id,self.status];
