...
//  新增考勤组
#define CreateKaoqunGroup_Url @"http://zsylou.wxwkf.com/index.php/home/attence/new_attence_group"
...
// 获取通讯录数据
#define ContactList_Url @"http://zsylou.wxwkf.com/index.php/home/easemob/linkman?uid=%@"
// 模糊查询通讯录
#define SearchUser_URL @"http://zsylou.wxwkf.com/index.php/home/easemob/find_man?uid=%@&nickname=%@"
// 建立群组,uid：自己，群主，不需要放进members里。members：成员的UID
#define CreaterGroup_url @"http://zsylou.wxwkf.com/index.php/home/easemob/setup_group?uid=%@&members=%@"
// 群组成员
...
// 九宫格--全部模板
#define NineList_Url @"http://zsylou.wxwkf.com/index.php/wei/retransmission/index?uid=%@"
// 九宫格--搜索模板
#define NineSearch_Url @"http://zsylou.wxwkf.com/index.php/wei/retransmission/search?uid=%@&keyword=%@"
// 九宫格--分类模板列表
#define NineCategory_Url @"http://zsylou.wxwkf.com/index.php/wei/retransmission/lists?uid=%@&id=%@&page=%d&nums=%d"
#define NineTeamClassMobanList_Url @"http://zsylou.wxwkf.com/index.php/wei/retransmission/lst?uid=%@&id=%@"
// 九宫格--关注列表
#define NineCareList_Url @"http://zsylou.wxwkf.com/index.php/wei/retransmission/myCare?uid=%@"
// 九宫格--编辑关注模本分类
#define NineCareEdit_Url @"http://zsylou.wxwkf.com/index.php/wei/retransmission/updateCareCate?uid=%@&care=%@"
// 九宫格--团队已经使用
#define NineTeamUsed_Url @"http://zsylou.wxwkf.com/index.php/wei/retransmission/groupRetrans?uid=%@&date=%@"
// 九宫格--我已经使用
#define NineMyUsed_Url @"http://zsylou.wxwkf.com/index.php/wei/retransmission/myRetrans?uid=%@&date=%@"
// 九宫格--添加团队分类
#define NineAddTeamClass_Url @"http://zsylou.wxwkf.com/index.php/wei/retransmission/create_category?uid=%@&name=%@"
// 九宫格--模板详情
#define NineDetial_Url @"http://zsylou.wxwkf.com/index.php/wei/retransmission/detail?uid=%@&id=%@&date=%@"
// 九宫格--转发提醒
#define NineResendTips_Url @"http://zsylou.wxwkf.com/index.php/wei/retransmission/retransRemind?uid=%@&id=%@"
// 九宫格--上传模板
#define UpLoadMoban_Url @"http://zsylou.wxwkf.com/index.php/wei/retransmission/create"
// 九宫格--删除我的模板
#define DeleteMyMoban_Url @"http://zsylou.wxwkf.com/index.php/wei/retransmission/delete?uid=%@&id=%@"
// 九宫格--获取团队制作的分类
#define TeamClasses_Url @"http://zsylou.wxwkf.com/index.php/wei/retransmission/teamCategory?uid=%@"
// 九宫格--我的模板
