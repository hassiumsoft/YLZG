...
#define myWidth (SCREEN_WIDTH - 2.5)/6

@interface OutTitleColorView ()
...
@implementation OutTitleColorView

- (instancetype)initWithFrame:(CGRect)frame Color:(UIColor *)color Title:(NSString *)title
{
    OutTitleColorView *colorV = [[OutTitleColorView alloc]initWithFrame:frame];
