...
- (void)commonInit {http://qzone.qq.com/
    [self setupDefault];
    [self createLayers];
...
- (UILabel *)descriptionLabelWithIndex:(NSInteger)index {
    ...
    KGLog(@"angle is %@", @(centerAngle / 2 / M_PI *360));
...
- (void)handleTapGesture:(UITapGestureRecognizer *)sender {
    ...
    KGLog(@"location is %@", NSStringFromCGPoint(location));
