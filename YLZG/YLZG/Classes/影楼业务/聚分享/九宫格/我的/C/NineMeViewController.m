...
@interface NineMeViewController ()<UIScrollViewDelegate>
...
@implementation NineMeViewController
...
- (void)setupSubViews
{
    self.titleArray = @[@"团队已用",@"我已使用",@"我的模板"];
    /** 初始化顶部标签滚动栏 */
...
{
    TeamUsedViewController *vc = [self.childViewControllers firstObject];
...
- (void)addController
{
    TeamUsedViewController * vc1 = [[TeamUsedViewController alloc] init];
//    vc1.saleModel = self.saleModel;
    [self addChildViewController:vc1];
    
    MyUsedViewController * vc2 = [[MyUsedViewController alloc] init];
//    vc2.saleModel = self.saleModel;
    [self addChildViewController:vc2];
    
    MyMobanViewController * vc3 = [[MyMobanViewController alloc] init];
    //    vc2.saleModel = self.saleModel;
...
- (void)scrollViewDidEndScrollingAnimation:(UIScrollView *)scrollView
{
    ...
    // 添加控制器
    if (index == 0) {
        TeamUsedViewController *newsVc = self.childViewControllers[index];
        ...
        MyUsedViewController *newsVc = self.childViewControllers[index];
        ...
        MyMobanViewController *newsVc = self.childViewControllers[index];
