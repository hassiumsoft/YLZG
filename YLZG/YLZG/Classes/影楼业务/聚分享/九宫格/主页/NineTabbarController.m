...
- (void)viewDidLoad {
    ...
    [self addChildVC:checkWork Title:@"素材市场" image:@"ico_scratchablelatex" selectedImage:@"ico_scratchablelatex_blue" Tag:1];
    
    NineMyCareViewController *zenVC = [[NineMyCareViewController alloc]init];
    [self addChildVC:zenVC Title:@"关注" image:@"ico_focuson" selectedImage:@"ico_focuson_blue" Tag:2];
