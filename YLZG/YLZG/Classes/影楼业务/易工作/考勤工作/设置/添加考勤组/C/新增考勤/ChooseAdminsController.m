...
@interface ChooseAdminsController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation ChooseAdminsController
...
- (void)doneAction
{
    if ([self.delegate respondsToSelector:@selector(chooseAdminWithArray:)]) {
        [self.delegate chooseAdminWithArray:self.chooseArray];
        [self dismiss];
    }
}
- (void)dismiss
